registerScript("ro", "hot_3", {
  title: "Cleorix",
  stages: {
    greeting: `<p>Bună ziua! Vorbesc cu dl\dna. ......? Ma numesc .....sunt medig gastrolog al centrului de sananatate HelProtect. dvs ati lasat o solicitare la produsul <b>Cleorix</b>,puteti sa discutam acuma?</p>
    <p>-Dacă clientul este gata să vorbească, atunci trecem la pasul 2.</p>
    <p>-Dacă nu: când putem suna înapoi?</p>`,
    needs: `
    <p>1. Câți ani aveți?</p>
<p>2. Cumpărați produsul pentru dumneavoastră sau pentru altcineva?</p>
<p>3. Ce doriti sa rezolvati si cu ce problema va confruntati.</p>
<p class="presentationTitle">Daca clientul are probleme cu colonul,balonari, diaree sau constipatie-continuati cu  urmatoarele intrebari:</p>

<Pentru>4. Vă rugăm să descrieți mai detaliat care este problema dvs.?
(de câte ori pe zi ai mișcare intestinală? de cât timp ai probleme cu intestinul? această problemă este cauzată de administrarea anumitor medicamente, alte boli? 
Și când ai observat că a apărut această problemă? Pentru că mulți factori pot cauza probleme intestinale:</p>
<ul>
<li>Lipsa de mișcare.</li>
<li>Sindromul intestinului iritabil.</li>
<li>Abuzul de laxative)</li>
</ul>
<p>5. Ați folosit alte produse pentru a rezolva problema?</p>
<p>6. Aveți probleme digestive?</p>
<p>7. Aveți constipație sau diaree, Daca da-cat de des?</p>
<p class="p-accent-green">Dacă acestea sunt o prezență constantă, e ca și cum organismul dumneavoastră ar cere ajutor pentru ca este epuizat, incapabil să mai lupte singur. Fiecare zi fără soluție e un pas mai aproape de complicații precum ulcere care vă macină stomacul sau tumori care vă amenință viața.</p>
<p>8. Dureri de stomac, taituri abdominale aveti?</p>
<p>9. Balonari abdominale simtiti?</p>
<p class="p-accent-green">Balonarea nu e doar o mica neplacere, ci o bombă cu ceas în intestinele dumneavoastră, pentru ca toxinele se acumulează, gazelle vă apasă din interior, iaceea ce va pune in pericol sănătatea dumneavoastră</p>
<p>10. Ce probleme ale tractului digesstiv au fost diagnosticate?</p>
<p class="p-accent-green">Este extrem de important să grăbim metabolismul, să grăbim digestia, astfel încât nimic să ne împiedice să golim colonul, să eliminăm constipația și să începem să ne bucurăm să mâncăm ceva gustos, și nu de la problemele intestinale, nu-i așa?</p>
<p class="p-accent-green">Nerezolvarea problemei în timp util poate avea consecințe grave (le vom enumera)- duc neapărat la boli cronice, colită, ulcere gastrice sau, Doamne ferește, oncologiece</p>
<p>Deci din câte am înțeles domnule/doamnă.....mai aveți problema de curățare/detoxifiere corporală
(le numim probleme ale clientului pe care le-am descoperit prin întrebările puse).
Cu toate acestea, știm că în timp aceste probleme de sănătate se pot agrava, dacă nu le tratati acum.
Este posibil să fiți și internat în spital și atunci va fi mai dificil să rezolvați problema de sănătate</p>
...
<p>Ca specialist in domeniu, recomand acest tratament 100% ca sa rezolvam problema pe care o aveti de mult timp,</p>
<p>Produsul --------l este natural (organic), testat și aprobat medical, care ajută la detoxifierea organismului, eliminarea microbilor și paraziților corpului, de asemenea:</p>
<ul>
<li>hraneste ficatul cu vitaminele si mineralele necesare</li>
<li>imbunatateste microflora intestinala</li>
<li>detoxifică organismul</li>
<li>curăță sângele de toxine</li>
<li>normalizeaza digestia</li>
<li>elimina papiloamele</li>
<li>elimină paraziții și microbii intestinali</li>
</ul>

<p>În prezent, toate componentele benefice pe care le luați din alimentatie pur și simplu nu sunt asimilate, prin urmare organismul pur și simplu nu are resursele necesare pentru digestia alimentelor, golirea colonului și pentru a menține o stare sănătoasă a organismului, la acest fapt indică  (simptomele: constipatiile, balonarile, gazele intestinale, insomnia, crizele nervoase și de agitație) care cu siguranta duc la boli cronice, colită, ulcer gastric sau nu da Domnul la o oncologie.</p>
<p>Mai ales dacă țineți cont și de faptul că acest lucru se poate face numai din interior! 
Și, prin urmare, metabolismul accelerat va garantează nu doar scaune regulate și golirea ușoară a colonului dar și longevitate, putere, energie și îmbunătățirea stării generale a organismului  fără risc de boli cronice,  operații și cancer de colon.</p>
<p>Pentru curatarea organismului de zgură și toxine folosim deja - Farmacin, acum trebuie să acționăm direct asupra cauzei care duce la (simptomele: constipatii, balonari, gaze intestinale, insomnie, crizele nervoase și de agitație), sa acceleram metabolismul si sa reveniti la etapa în care ve-ti avea un scaun ușor, veți putea goli colonul fără a întâmpina greutăți, cu asta va va ajuta produsul Kaningem, care asigură o absorbţie completă a componentelor Farmacinului datorită refacerii microflorei gastrointestinale  și datorită cărora veți simți o digestie mai ușoară, un scaun  în fiecare zi, un somn mai calitativ și mai profund, iar dimineața va veți trezi plini de energie și putere, și acest fapt va fi un semn, că organismul dvs este complet curatat si scaunul normalizat, doar asta va doriti?</p>
<p>Formula <b> Cleorix</b> conține o combinație unică și echilibrată a acestor ingrediente naturale pentru a susține sănătatea digestivă și imunitară în lupta împotriva infecțiilor intestinale și a paraziților.</p>
<ol>
<li>Dovleacul – posedă proprietăți antiinflamatorii și antifungice, ajutând la combaterea infecțiilor fungice și bacteriene din organism.</li>
<li>Ginseng – posedă proprietăți antibacteriene, antivirale și antifungice, susținând sistemul imunitar și apărarea organismului împotriva infestărilor cu helminți.</li>
<li>L-Arginina – este un puternic agent antioxidant și antiinflamator, reducând inflamația cauzată de infecții.</li>
<li>L-Carnitină – conține compuși antimicrobieni și antiinflamatori, ajutând organismul să combată bolile și simptomele acestora, precum și să reziste recidivelor.</li>
<li>Extract de tinctură – promovează detoxifierea organismului, neutralizează toxinele formate în timpul infecțiilor parazitare și elimină durerile și spasmele abdominale.</li>
</ol>

<p>Un remediu antiparazitar poate ajuta la tratarea multor simptome asociate cu prezența viermilor intestinali în organism. Acestea includ:</p>
<ul>
<li>dureri abdominale,</li>
<li>diaree,</li>
<li>greață și vărsături,</li>
<li>flatulență excesivă,</li>
<li>pierdere neintenționată în greutate și</li>
<li>oboseală cronică.</li>
</ul>
<p>Ca de exemplu am avut un:..................................................<span class="txt-blue">(Aicea fiecare operator isi face o istorie precum a ajutat acest produs unui client)</span></p>
`,

    courses: `
  <p>După cum puteți vedea, produsul nostru are o gamă largă de acțiune. Ca specialist, este foarte important pentru mine să vă ajut și să vă rezolv problema, cu care vă luptați de mult.Enumerati problemele clientului, puneti accent pe agravari si ce vrea sa rezolve cientul, + cand prezentati curele spuneti mai intii perioada.</p>
...
<p>Deci, pentru grupul dvs de vârsta (indicăm vârsta clientului) și situația dumneavoastră (enumerăm ce efecte dorește clientul să obțină și ce probleme trebuie să rezolve), va propund ca sa lucram impreuna macar 60 zile, ca sa va ajut sa ajungeti la rezultate maxime.Eu va adaug la mine in grupul de pacienti, si sa stiti ca fiecare saptamana am sa va sun sa verifi care este situatatia si cum va simtiti.</p>
<p class="presentationTitle">ASTEPTATI RASPUNSUL CLIENTULUI, DACA ESTE DE ACORD SA LUCREZE IMPREUNA 2 LUNI, DUPA PREZENTATI PRETUL….</p>
...
<p>A urma un curs de 60 de zile 2 tabletă pe zi) ajută la:</p>
<ul>
<li>hraneste ficatul cu vitaminele si mineralele necesare</li>
<li>imbunatateste microflora intestinala</li>
<li>detoxifică organismul</li>
...
<p><b>Cursul „Super Eficient”</b> este o ofertă eficientă din punct de vedere al rezultatului final și o ofertă la fel de avantajoasă din punct de vedere al prețului.</p>
<p><span class="txt-blue">(Ne oprim și așteptăm ca clientul să spună ceva)</span></p>
<p>- Ce zici dacă plasăm o comandă?</p>
<p span class="txt-red"? class="presentationTitle">Prelucrarea de baza se ofera dupa lucrul cu clientul procesand minim 2 obiectii!!!!</p>
<p>2) <b>Cursul de tratament „de bază”</b>, care durează 50 de zille, este format din 5 cutii și costă doar ……..lei + transport gratuit</p>
<p>Luarea medicamentului timp de 50 de zile (2 comprimat pe zi) ajută la:</p>
<ul>
<li>hraneste ficatul cu vitaminele si mineralele necesare</li>
<li>imbunatateste microflora intestinala</li>
<li>detoxifică organismul</li>
...
<p>După finalizarea acestui curs, rezultatul tratamentului este înregistrat timp de până la 4 ani.</p>
<p>Dar este important nu numai să scapi temporar de (numiți simptomele clientului), ci și să continuați să trăiți o viață plină și să restabiliți activitatea de zi cu zi pentru o lungă perioadă de timp. sunteti de acord cu mine?</p>
<p><span class="txt-blue">(Ne oprim și așteptăm ca clientul să spună ceva)</span></p>
<p>- Ce zici dacă plasăm o comandă?</p>
<p span class="txt-red"? class="presentationTitle">Daca clientul nu este de acord propuneti 4 cutii..si tot asa diminuati din cutii si pret!!!</p>
 <div id="pricingBlock"></div>

`,

    cross: `<p class="presentationTitle">Vă sugerăm dacă un bărbat este supraponderal:</p>
...
<p>„Bine, vă rugăm să scrieți numărul liniei noastre de asistență telefonică – dacă aveți întrebări – vă vom ajuta cu plăcere: 40373760656”. Vă voi monitoriza rezultatele, așa că vă rugăm să răspundeți la următorul apel.</p>
