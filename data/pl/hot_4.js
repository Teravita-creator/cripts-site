registerScript("pl", "hot_4", {
  ...
  stages: {
    ...
    <p>Dzień dobry, czy rozmawiam z Panem/Panią _________ <span class="txt-blue">(imię klienta)</span>? </p>
      ...
      <p>Dobrze, Prosta Lumina jest bardzo potężny produkt, który wymaga odpowiedniej dawki. Dlatego zadam Panu/Pani teraz kilka pytań, aby móc doradzić Panu jak najdokładniej. Dobrze?</p>`,
    needs: `
  ...
  <div id="needsBranches"></div>
    ...
    `,
    presentation: `
    <p>Panie ______ <span class="txt-blue">(imię klienta)</span>, Prosta Lumina jest idealnym rozwiązaniem, ponieważ jest całkowicie naturalny ta bezpieczny <span class="txt-red">(dla serca, wątroby i żołądka)</span>, co jest ważne w przypadku Pana <span class="txt-red">(Choroby przewlekłe Klienta)</span>. Produkowany w UE, z certyfikatami jakości i z już udokumentowanymi pozytywnymi wynikami.</p>
...
<div id="presentationFlow"></div>
 ...
 <p class="presentationTitle">Jak go używać?</p>
  <p>Proszę stosować <b>1 razy dziennie</b> i popić go szklanką wody. Rekomenduję wypijać 1,5 litra wody w ciągu dnia – ułatwi to lepsze wchłanianie przez organizm.</p>`,
    courses: `
...
<p>Może Pan przejść <b>Kurację Podstawową</b>. Ten program jest przeznaczony na 2 miesiąca stosowania składają się 4 opakowań, tutaj otrzyma Pan 1 opakowanie za darmo , <b>cena wynosi 431 zł, razem z przesyłką 20 zł. Zabezpieczy Pan wynik na kolejny rok</b>. Szczerze chcę Panu pomóc, ponieważ rozumiem, że pilnie potrzebuje Pan rozwiązać problem.</p>
...
<p span class="txt-red"? class="presentationTitle"> Przynajmniej 2 razy rozpatrzymy sprzeciw i dopiero wtedy zaproponujemy niższą kuracją  </p>
<p>Panie ________ (Imię Klienta), rozumiem Pana sytuację, ale po prostu potrzebuje Pan powrotu do zdrowia, ponieważ sytuacja jest zaawansowana. W takim przypadku spójrzmy na inne opcje. </p>
<p>Może Pan przejść <b>Kurację Podstawową</b>. Ten program jest przeznaczony na 2 miesiąca stosowania składają się 4 opakowań, <b>cena wynosi 416  zł, razem z przesyłką 20 zł. Zabezpieczy Pan wynik na kolejny 1,5 roku</b>. Szczerze chcę Panu pomóc, ponieważ rozumiem, że pilnie potrzebuje Pan rozwiązać problem.</p>
<p>Zapewniam Pana, że po zobaczeniu wyników będzie Pan chciał zamówić więcej. Specjalnie przydzielę Panu zniżkę, dzięki której, jeśli zajdzie taka potrzeba, będzie Pan mógł dokupić dodatkowe opakowania w promocji. Może więc zostaniemy przy minimalnej opcji? </p>
    </div>
  `,
    },
...
<p>Panie ________ (Imię Klienta), rozumiem Pana sytuację, ale po prostu potrzebuje Pan powrotu do zdrowia, ponieważ sytuacja jest zaawansowana. W takim przypadku spójrzmy na inne opcje. </p>
<p>Może Pan przejść <b>Kurację Podstawową</b>. Ten program jest przeznaczony na 1,5 miesiąca stosowania składają się z 3 opakowań, tutaj otrzyma Pan 1 opakowanie za 59 zł i 2 kolejnych z rabatem, <b>cena wynosi 353  zł</b>, razem z przesyłką 20 zł. Zabezpieczy Pan wynik na kolejny rok/b>. Szczerze chcę Panu pomóc, ponieważ rozumiem, że pilnie potrzebuje Pan rozwiązać problem.</p>
<p>Zapewniam Pana, że po zobaczeniu wyników będzie Pan chciał zamówić więcej. Specjalnie przydzielę Panu zniżkę, dzięki której, jeśli zajdzie taka potrzeba, będzie Pan mógł dokupić dodatkowe opakowania w promocji. Może więc zostaniemy przy minimalnej opcji? </p>
    </div>
  `,
    },
...
presentationFlow: [
  {
    textHtml: `<p><b>W pierwszym etapie</b> Prosta Lumina eliminuje bakterie i stany zapalne oraz wspomaga procesy metaboliczne, co pozwala prostacie odzyskać prawidłową strukturę i funkcję. Następuje oczyszczenie naczyń krwionośnych, zatory i normalizacja krążenia krwi w narządach miednicy. Nasze kapsułki działają kumulacyjnie — organizm stopniowo wchłania składniki aktywne, dlatego pierwsze wyraźne efekty najczęściej pojawiają się po 3–4 tygodnia regularnego stosowania.</p>`,
    buttons: [
...
products: [
  {
    name: "Prosta Lumina",
    image: "assets/products/pl/product6.jpg", // або https://...
    origin: "Ryga, Łotwa",
    format: "10 szt./opak",
    usage: "1 razy./dzień",
    
    ingredients: [
      { name: "Kwas askorbinowy (Witamina C)", effect: "Silny antyoksydant, który chroni komórki prostaty przed uszkodzeniami wywołanymi przez wolne rodniki. Wspiera ogólną odporność organizmu." },
      { name: "Ekstrakt z zielonej herbaty (40% polifenoli)", effect: "Zawiera związki (EGCG), które mają działanie przeciwzapalne i mogą hamować niekontrolowany podział komórek w obrębie gruczołu krokowego" },
      { name: "Ekstrakt z palmy sabałowej (Saw Palmetto) (5% kwasów tłuszczowych)", effect: "Najważniejszy składnik roślinny w suplementacji prostaty. Pomaga łagodzić objawy łagodnego przerostu gruczołu krokowego (BPH), ułatwiając oddawanie moczu i zmniejszając parcie na pęcherz." },
      { name: "Ekstrakt z żurawiny", effect: "Wspomaga drogi moczowe, zapobiegając infekcjom bakteryjnym, co jest kluczowe przy utrudnionym odpływie moczu związanym z powiększoną prostatą." },
      { name: "Proszek z brokułów", effect: "Bogate źródło sulforafanu, który wspomaga naturalne procesy detoksykacji organizmu i wykazuje działanie ochronne na komórki prostaty." },
      { name: "Ekstrakt z kłącza kurkumy (10% kurkuminy)", effect: "Wykazuje bardzo silne właściwości przeciwzapalne, co pomaga redukować obrzęki i ból w obrębie miednicy mniejszej." },
      { name: "Tlenek cynku", effect: "Cynk jest niezbędny dla zdrowia mężczyzny. Prostata gromadzi największe ilości tego pierwiastka w całym organizmie; jego niedobór wiąże się z ryzykiem przerostu gruczołu." },
      { name: "Drożdże selenowe (2000 ppm)", effect: "Selen wspiera procesy antyoksydacyjne i współdziała z cynkiem w profilaktyce zmian nowotworowych oraz stanów zapalnych prostaty." },
      { name: "Likopen", effect: "Naturalny barwnik (karotenoid), który jest jednym z najlepiej przebadanych składników wspomagających zdrowie prostaty. Może obniżać poziom markerów stanu zapalnego (np. PSA)." },
      { name: "Składniki pomocnicze (Technologiczne):", },
      { name: "Żelatyna", effect: "Składnik otoczki kapsułki." },
      { name: "Celuloza mikrokrystaliczna", effect: "Substancja wypełniająca." },
      { name: "Roślinny stearynian magnezu", effect: "Substancja przeciwzbrylająca." },
      { name: "Węglan wapnia", effect: "Stabilizator i wypełniacz." },
